...
export function EmergencyButton() {
  ...
  return (
    <>
      <Card className="bg-destructive border-red-800/80 text-destructive-foreground group-data-[collapsible=icon]:bg-transparent group-data-[collapsible=icon]:border-0">
        <CardHeader className="p-3 group-data-[collapsible=icon]:p-0">
          <CardTitle className="text-base text-destructive-foreground group-data-[collapsible=icon]:hidden">Emergency</CardTitle>
        ...
        <CardContent className="p-3 pt-0 flex flex-col items-center justify-center">
          <Button
            variant="destructive"
            className="w-full h-24 rounded-lg shadow-lg bg-red-700 hover:bg-red-800 text-white text-lg font-bold flex flex-col items-center justify-center gap-2 transition-transform active:scale-95 group-data-[collapsible=icon]:h-16 group-data-[collapsible=icon]:w-16"
